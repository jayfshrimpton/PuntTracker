  ...
  return (
    <div>
      <button
        ...
        className="ml-2 inline-flex items-center justify-center w-6 h-6 rounded-full bg-muted text-foreground hover:bg-muted/80 text-sm"
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-card border border-border rounded-lg shadow-xl max-w-2xl w-full mx-4 p-6 space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-semibold text-foreground">Bet Types Guide</h3>
            ...
            <div className="space-y-3 text-sm text-foreground">
              ...
              <p className="text-xs text-muted-foreground">All currency values rounded to 2 decimals. AU totes/dividends are per $1 unit.</p>
            </div>
          </div>
        </div>
      )}
